...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-04 13:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a838abab-348f-4bbc-95ee-ee94f2d8b93b.git
$ cd a838abab-348f-4bbc-95ee-ee94f2d8b93b
```
